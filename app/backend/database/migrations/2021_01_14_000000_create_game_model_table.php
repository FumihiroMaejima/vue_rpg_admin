...
class CreateGameModelTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('game_enemy', function (Blueprint $table) {
            ...
            $table->foreignId('ability1_id')->constrained('game_ability')->nullable()->comment('能力1');
            $table->foreignId('ability2_id')->constrained('game_ability')->nullable()->comment('能力2');
            $table->foreignId('ability3_id')->constrained('game_ability')->nullable()->comment('能力3');
        ...
        Schema::create('game_player_item_list', function (Blueprint $table) {
            $table->id();
            $table->foreignId('player_id')->constrained('game_player')->comment('プレイヤーID');
            $table->foreignId('content1')->constrained('game_item')->nullable()->comment('コンテンツ1');
            $table->foreignId('content2')->constrained('game_item')->nullable()->comment('コンテンツ2');
            $table->foreignId('content3')->constrained('game_item')->nullable()->comment('コンテンツ3');
            $table->foreignId('content4')->constrained('game_item')->nullable()->comment('コンテンツ4');
            $table->foreignId('content5')->constrained('game_item')->nullable()->comment('コンテンツ5');
            $table->foreignId('content6')->constrained('game_item')->nullable()->comment('コンテンツ6');
            $table->foreignId('content7')->constrained('game_item')->nullable()->comment('コンテンツ7');
            $table->foreignId('content8')->constrained('game_item')->nullable()->comment('コンテンツ8');
            $table->foreignId('content9')->constrained('game_item')->nullable()->comment('コンテンツ9');
            $table->foreignId('content10')->constrained('game_item')->nullable()->comment('コンテンツ10');
            $table->foreignId('content11')->constrained('game_item')->nullable()->comment('コンテンツ11');
            $table->foreignId('content12')->constrained('game_item')->nullable()->comment('コンテンツ12');
            $table->foreignId('content13')->constrained('game_item')->nullable()->comment('コンテンツ13');
            $table->foreignId('content14')->constrained('game_item')->nullable()->comment('コンテンツ14');
            $table->foreignId('content15')->constrained('game_item')->nullable()->comment('コンテンツ15');
            $table->foreignId('content16')->constrained('game_item')->nullable()->comment('コンテンツ16');
            $table->foreignId('content17')->constrained('game_item')->nullable()->comment('コンテンツ17');
            $table->foreignId('content18')->constrained('game_item')->nullable()->comment('コンテンツ18');
            $table->foreignId('content19')->constrained('game_item')->nullable()->comment('コンテンツ19');
            $table->foreignId('content20')->constrained('game_item')->nullable()->comment('コンテンツ20');
            $table->timestamps();
            $table->softDeletes();
        });
    }
